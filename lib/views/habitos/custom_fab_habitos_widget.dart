...
class CustomFABHabitoWidget extends StatefulWidget {
  const CustomFABHabitoWidget({Key? key}) : super(key: key);

  @override
  State<CustomFABHabitoWidget> createState() => _CustomFABWidgetState();
}

class _CustomFABWidgetState extends State<CustomFABHabitoWidget> {
                                ...
                                SizedBox(
                                  ...
                                  child: Observer(builder: (_) {
                                    return ListView.builder(
                                      itemCount:
                                          habitoController.horarios.length,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        if (textEditingController.text.isEmpty) {
                          ...
                          habitoController
                              .addHabito(textEditingController.text)
                              .then((value) {
